...
pr\'esentent sur le serveur et le client ressemble \`a celui pr\'esent
...
$$User: \{\_id, username, email, admin\_email,

\{id\_machine, name, home\_directory, quota\_available, quota\_left, CPU, RAM, OS\}\}$$
