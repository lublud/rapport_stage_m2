...
Enfin, en ce qui concerne le d\'eveloppement, la contrainte que j'avais \'etait
d'utiliser le C++ et de d\'evelopper de mani\`ere orient\'e objet tout en
faisant en sorte que le code puisse \^etre robuste, lisible, testable, et donc
...
Unix. Le c\oe ur du pro\\amme est son algorithme :
...
\begin{description}
 ...
 \item [Avantage et inconv\'enients :] En utilisant le chiffrement homomorphe,
 le plus gros du calcul se fait sur le serveur entre deux backup, et ceux pour
