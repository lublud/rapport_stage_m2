...
phase de prototypage semblait in\'evitable.

Dans ce cadre, j'ai \'ecrit l'algorithme en \textit{C++} afin de v\'erifier
le temps d'ex\'ecution de celui-ci. Plusieurs essai ont \'et\'e fait afin de
...
qu'au niveau de l'\'ecriture du code en lui-m\^eme, 
