...
j'ai pass\'e mes six mois de stage. Les locaux, accueillant le centre de
...
d\'et\'erior\'ee sur la fin d\^u \`a la restructuration de l'entreprise qu'\`a
pu se d\'erouler ce stage de fin d'\'etude.
...
documenter dans un premier temps sur les diff\'erentes solution qui existent
d\'ej\`a avant de trouver un algorithme r\'epondant \`a la probl\'ematique.
...
Ce qui est int\'eressant dans \textit{Syncthing} est pour nous le protocole de
