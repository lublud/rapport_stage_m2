...
\paragraph{Frameworks et biblioth\`eques externes}
...
\paragraph{D\'eveloppement des modules}
...
\paragraph{Imbrication des modules}
Cette \'etape fut longue et beaucoup d'erreur apparurent. Bien que chaque
module, individuellement, fonctionnait parfaitement, les faire fonctionner sur
des threads s\'epar\'es et communiquer tous ensemble amena quelque probl\`emes :

\begin{itemize}
 \item Lib\'eration de la m\'emoire d'objets contenant les informations trop
 t\^ot, emp\^echant le bon fonctionnement des modules utilisant encore ces
 objets
 \item Fuite de m\'emoire li\'ee \`a l'utilisation de plusieurs threads avec
 de la m\'emoire pas toujours lib\'er\'ee
 \item Soucis dans l'abonnement de certains modules pour certains type de
 notifications
 \item Chiffrement correct de fichier devant \^etre d\'ecoup\'e en de nombreux
 morceaux diff\'erent, et donc impossibilit\'e de d\'echiffrement
\end{itemize}
